...
exports.get = function(req, res) {
	...
	switch(query.dotw) {
		...
		case 'Fri': {
			//console.log("Friday");
			date = new Date(2013, 02, 08,  13, 45);
			break;
		}
		case 'Sat': {
...
//	date.setTimezone("US/Central");
	...
	for ( i = 0; i < teamlist.VCALENDAR.VEVENT.length; ) {
		...
		var _startDate = new Date(2013, 02, day, hour, min);
	...
	//console.log(endday);
		...
		var _endDate = new Date(2013, 02, endday, endhour, endmin);
...
//if ( _numsessions <1 ) {
	...
	//} else {
			...
			"</li>",
			"<li class='hidden extra'>" + "<button type='button' class='close hidden' ><img src='assets/img/close.png'></button>" +
			"<div class='summary'>Are you this picky at the Four Seasons breakfast buffet?</div>" +
			"</li>"];
